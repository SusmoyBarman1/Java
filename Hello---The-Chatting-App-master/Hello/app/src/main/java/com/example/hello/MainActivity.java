...
public class MainActivity extends AppCompatActivity
{
    ...
    private void VerifyUserExixtance()
    {
    ...
    private void RequestNewGroup()
    {
        ...
        groupNameField.setHint("e.g: Cool bros!");
    ...
    {
        Intent findFriendsIntend = new Intent(MainActivity.this, FindFriendsActivity.class);
        startActivity(findFriendsIntend);
    }
